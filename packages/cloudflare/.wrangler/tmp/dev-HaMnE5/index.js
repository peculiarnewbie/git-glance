...
var GitGlanceDO = class extends DurableObject {
  ...
  constructor(ctx, env) {
    ...
    ctx.blockConcurrencyWhile(async () => {
      const all = await ctx.storage.kv.list({ prefix: "agent:" });
...
// .wrangler/tmp/bundle-N4L12E/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-N4L12E/middleware-loader.entry.ts
